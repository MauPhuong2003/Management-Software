...
const wheelSlotSchema = new mongoose_1.Schema(({
    giftId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Gift', required: true },
...
exports.default = mongoose_1.default.model('MiniGame', miniGameSchema);
