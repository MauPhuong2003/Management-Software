...
const promotionSchema = new mongoose_1.Schema({
    ...
    applyProductIds: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Product' }],
    buyProductId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Product' },
    buyQty: { type: Number, default: 1 },
    getProductId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Product' },
